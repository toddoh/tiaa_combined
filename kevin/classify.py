...
#read json data
with open('./dataset/trump_promises.json') as data_file:
    policydata = json.load(data_file)

policysentence = []
for item in policydata['promises']:
    policysentence.append(item['title'])
...
for item in policysentence:
    print(item)
    classinfo = input()
    training_data.append({"class":classinfo, "sentence":item})
...
print()
classify("how are you? I'm having sandwich for lunch", show_details=True)