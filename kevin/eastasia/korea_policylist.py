...
for item in policydata:
    for stra in item['strategies']:
        for tsk in stra['task']:
            aggregated.append(tsk['name'])
            for desc in tsk['description']:
                aggregated.append(desc['name'])
