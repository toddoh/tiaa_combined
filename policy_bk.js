...
const render_policy = () => {
    ...
    const policykeywords_markup = () => html`
        ...
        <div class="policygroup" banana-status="unfolded">
    ...
    const policycats_markup = () => html`
        <p><strong class="bolder">주제별로 보기</strong></p>
        <div class="categories">
            ${allcategories.map((cat) => html`
                <p class="category"><strong class="bolder">${cat}</strong></p>
            `
            )}
        </div>
    `;
    
    render(policycats_markup(), document.querySelector('.ea-korea-policylist .policylist-categories'));
}