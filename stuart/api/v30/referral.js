...
router.route('/request').post(authUser, function(req, res, next){
...
router.route('/request').get(authUser, function(req, res, next){
...
router.route('/accept').post(authUser, function(req, res, next){
